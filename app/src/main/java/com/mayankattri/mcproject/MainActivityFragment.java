 ...
 */
public class MainActivityFragment extends Fragment implements AddGeofenceFragment.AddGeofenceFragmentListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        viewHolder.actionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogFragment.setListener(MainActivityFragment.this);
